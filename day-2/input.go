...
func getInput() []string {
	return strings.Split(`Game 1: 10 red, 7 green, 3 blue; 5 blue, 3 red, 10 green; 4 blue, 14 green, 7 red; 1 red, 11 green; 6 blue, 17 green, 15 red; 18 green, 7 red, 5 blue
...
func getExample2Input() []string {
	return getExample1Input()
}
